 ...
 * `prisma.category`: Exposes CRUD operations for the **Category** model.
  ...
  */
    ...
    /**
     * `prisma.customMeasurement`: Exposes CRUD operations for the **CustomMeasurement** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more CustomMeasurements
      * const customMeasurements = await prisma.customMeasurement.findMany()
      * ```
      */
    get customMeasurement(): Prisma.CustomMeasurementDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
