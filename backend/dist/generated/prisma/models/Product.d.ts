...
export type ProductOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "name" | "slug" | "description" | "basePrice" | "isCustomizable" | "isActive" | "categoryId" | "createdAt" | "updatedAt", ExtArgs["result"]["product"]>;
